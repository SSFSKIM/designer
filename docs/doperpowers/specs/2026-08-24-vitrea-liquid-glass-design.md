...
- **C9c — docs & packaging**: package READMEs, NOTICE trademark clause, changeset, publish dry-run. Blocked-by: C9a claims wording. External gate: npm org creation + publish auth (user).
