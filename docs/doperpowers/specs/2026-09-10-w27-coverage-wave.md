 ...
 **G1d dispatched 2026-09-14 (Decision Logs 18 and 19):** the anchor cell T1 needs is captured on the 26.5 machine before it updates, and the two fits — T1 with its anchor, the accessibility level per policy — are made on one configuration with one holdout read and one re-application of the bound (claims §5.143).
