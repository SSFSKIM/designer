...
- **Status:** G0 closed; G1 fitted and declared 2026-09-10 (claims §5.130), reviewed by the
  ...
  **G1c, the model-form fit, RUN 2026-09-13 (Decision Log 17; claims §5.141):** the accessibility
  ...
  reference as an opaque panel per policy — 0.95597 to five decimals on all fourteen Reduce
  Transparency cells over five backdrops at spans 32–160 — and two existing light-entry fields
