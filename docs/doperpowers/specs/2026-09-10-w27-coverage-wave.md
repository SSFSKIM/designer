...
- **Status:** G0 closed; G1 fitted and declared 2026-09-10 (claims §5.130), reviewed by the
  ...
  **The sitting was TAKEN 2026-09-12 and the checking bed READ 2026-09-13 (claims §5.136 §10 and
  ...
  structural findings beside the verdict: the recovered bed is **confirmed** — 24 of 28 group E cells
  reproduce their recovered fixtures byte-identically and the other four differ at one code on ≤0.14%
  of pixels, so Decision Log 5's admitted bed is now measured rather than argued; and the chroma
...
- 2026-09-13, **W27c's checking bed PUBLISHED and READ; the declared bound holds on two of six
  ...
  carry past the child. **Decision Log 5's admitted bed is now measured**: 24 of 28 re-attestation
  cells are byte-identical to their recovered fixtures and the rest differ at one code on ≤0.14% of
  pixels, so a fresh attested session reproduces a bed the record could only argue for. **The chroma
