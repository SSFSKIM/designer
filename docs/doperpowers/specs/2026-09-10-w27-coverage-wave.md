...
- 2026-09-13, **W27e G3's review fix wave CONVERGED: the corrected run taken, §2 re-derived from the
  ...
  canonical matrix row moved. **The user's eye is the only remaining G3 input, and it is not the
  committed sheets' to give**: those were composed against the first landing, at 17px/650 plate
  labels, so they are evidence for the operator and the four ink repairs and not for the type change
  the fix wave made.
