...
export {
  ...
  LENS_REFRACTION_GAIN,
  LENS_SIZE_GAIN_MAX,
  LENS_HEIGHT_PER_SPAN,
  LENS_HEIGHT_MAX,
  LENS_AMOUNT_PER_SPAN,
  LENS_AMOUNT_MAX,
  LENS_THICKNESS_REFERENCE,
  LENS_EXTENT_GAIN,
  LENS_PROFILE_EXPONENT,
  LENS_OVALIZATION,
  lensAmountBasePx,
  lensDepthPx,
  lensDirection,
  ...
  SIZE_OCCLUSION_GAIN,
  SIZE_SCATTER_FLOOR,
  SIZE_SCATTER_FLOOR_2X,
  SIZE_SCATTER_GAIN_FAR_2X,
  SIZE_SCATTER_GAIN_MAX,
  SIZE_SCATTER_GAIN_MAX_2X,
  SIZE_SCATTER_RAMP_REACH_1X_PX,
  SIZE_SCATTER_RAMP_REACH_2X_PX,
  SIZE_SCATTER_RAMP_START_FAR_1X,
  SIZE_SCATTER_RAMP_START_FAR_2X,
  SIZE_SCATTER_RAMP_START_THICK_1X,
  SIZE_SCATTER_RAMP_START_THICK_2X,
  SIZE_SCATTER_RAMP_START_THIN_1X,
  SIZE_SCATTER_RAMP_START_THIN_2X,
  SIZE_SCATTER_SPAN_MAX,
  SIZE_SCATTER_SPAN_MAX_2X,
