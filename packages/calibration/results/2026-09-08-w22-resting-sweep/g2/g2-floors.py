#!/usr/bin/env python3
"""W22 G2: every `REGRESSION_FLOORS` entry re-read against the landed matrix.
...
its bound is inert and comes off with its reason (W9 owns that; none is expected here).
