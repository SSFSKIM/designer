#!/usr/bin/env python3
"""W14 by-eye sheet (contract X5, `docs/doperpowers/specs/2026-09-03-w14-outer-shadow-colour.md`).
...
ROWS = [
    ...
    ('dark-solid__capsule-button__rest', 'capsule-button'),
    ('dark-solid__rrect-md__rest', 'rrect-md'),
...
def main():
    ...
    scale = args.scale
    zoom = 2 if scale == 1 else 1  # the same screen size per CSS px at both scales
    ...
    try:
        ...
        font = None
    banner = ('1 Apple native   2 vitrea W12 close   3 vitrea W14 candidate   '
              '4 diff (W12 close - native)   5 diff (candidate - native)   -- 4 and 5 are diagnostics, NOT renders')
