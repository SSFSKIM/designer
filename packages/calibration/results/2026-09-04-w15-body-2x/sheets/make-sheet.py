...
def main():
    ...
    ap.add_argument('--before', default=CANONICAL, help="the W13-bed captures dir (the canonical captures before this wave's rebuild)")
    ...
    for scene, component in ROWS:
        ...
        for img, name in ((before, 'W13 bed'), (after, 'candidate')):
    ...
    try:
        ...
        font = None
    banner = ('1 Apple native   2 vitrea W13 bed (before the 2x body)   3 vitrea W15 candidate   '
              '4 diff (W13 bed - native)   5 diff (candidate - native)   -- 4 and 5 are diagnostics, NOT renders')
