"""W25 G3 — the rows the landing must reproduce byte for byte (contract X3).
...
commit message.
    ...
    g3-digests.py <dry-run captures dir> <dry-run matrix.json> > g2-digests.txt
"""
...
def main():
    ...
    print("W25 G3 — the dry run's captures, at the frozen configuration")
