...
Named `nan-band` rather than `bisect`: a module of that name in this directory
shadows the standard library's own, and every sibling that reaches PIL through
`random` fails to import.
"""
