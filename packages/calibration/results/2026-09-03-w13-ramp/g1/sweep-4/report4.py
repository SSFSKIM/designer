"""The sweep-4 reader (sweep-3's, re-pointed at the W14 bed): the rows this wave turns on, per point, keyed by the
...
sys.path.insert(0, "/Users/new/.claude/jobs/5c70e47f/tmp/w13/sweep-4")
...
def tables(name, profileKey, axes, W=78):
    ...
    print("### per-cell ssimBand delta against the W14 bed, worst-cell order\n")
    ...
    seq = [("main(W14 bed)", None, base)] + [(l, o, r) for l, o, r, _, _, _, _, _, _ in order]
