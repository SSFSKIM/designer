#!/bin/sh
# The publish rehearsal at 0.20.0, short of publishing (claims §5.160 §7).
#
# W29 G4's script, unchanged but for this line and the scratch directory.
#
