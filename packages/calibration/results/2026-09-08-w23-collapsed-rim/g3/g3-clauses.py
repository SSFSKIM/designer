"""W23 G3 — the parent's clauses 1, 2, 3 and 4, each read with numbers, on both canonical beds.
...
The clauses, verbatim from the charter's Parent-Level Acceptance:
  ...
  4. *The band read closes.* Under W22's per-side band read, the eighteen sides on the three light
    ...
    g3-clauses.py <canonical-reads dir> [--out <file>]
"""
...
def main():
    ...
    emit("W23 G3 — the parent's clauses 1-4, read with numbers")
    emit("=" * 118)
