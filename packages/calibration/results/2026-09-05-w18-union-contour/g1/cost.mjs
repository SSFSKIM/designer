/**
 * W18 G1 (6) — S8's cost check, on W16 G0's harness.
 *
 * This is `results/2026-09-04-w16-css-two-layer/g0/cost.mjs` (unchanged) with its `pages/`
 * directory pointed at this wave's copy, which adds one form: W16's measured two-layer body plus
 * carrier B's container and casters. The knee is the surface count at which the compositor stops
 * holding the display's cadence, and S8 asks whether the elements this wave adds move it.
 *
 * W16 G0's header follows.
 *
