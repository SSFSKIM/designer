/**
 * W28 G4, step 3(b), second attempt: the demo losing focus to another application, read
 * without Playwright in the loop (claims §5.148).
 *
 ...
 *
 *   tsx results/2026-09-15-w28-g4-landing/real-focus.ts --out /tmp/w28-g4-focus
 *
...
const report = {
  gate: "W28 G4 — a real focus loss, read without a driver",
  claims: "§5.148",
