#!/bin/sh
# The publish rehearsal at 0.19.0, short of publishing (claims §5.155 §8).
#
# W28 G4's script, unchanged but for this line and the scratch directory.
#
